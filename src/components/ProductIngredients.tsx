              ...
              {keyIngredients.map((ingredient, index) => (
                ...
                >
                  <div className="mr-3 mt-1">
                    <Badge
                      variant="outline"
                      className="border-dbyou-purple text-dbyou-purple"
                    >
                      {ingredient.type}
                    </Badge>
                  </div>
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative transform hover:rotate-3 transition-transform duration-300">
                <img
                  ...
                  alt="Multi 5 Exfoliating BHA Toner от D'BYOU"
                  className="h-64 object-contain rounded-md shadow-lg bg-gradient-to-br from-white to-dbyou-lavender/30 p-3"
                />
                <div className="absolute -bottom-3 -right-3 bg-dbyou-purple text-white text-xs font-medium px-3 py-1 rounded-full">
                  120 мл
                </div>
              </div>
            </div>
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-dbyou-purple/80">
                        Продукт прошел все необходимые лабораторные тесты и
                        сертификацию.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-dbyou-purple/80">
                        Без парабенов и агрессивных компонентов, которые могут
                        навредить коже.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium">
                        Научно обоснованная формула
                      </h4>
                      <p className="text-dbyou-purple/80">
                        Каждый компонент тщательно подобран для достижения
                        максимального результата без нанесения вреда коже.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-dbyou-lavender">
                  <div className="flex items-center">
                    <Icon
                      name="AlertCircle"
                      className="h-5 w-5 text-dbyou-purple mr-2"
                    />
                    <p className="text-sm italic">
                      Перед использованием рекомендуется провести тест на
