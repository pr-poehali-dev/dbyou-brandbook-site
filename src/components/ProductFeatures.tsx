...
const features = [
  {
    ...
    description: "Мягко отшелушивает, не травмируя кожу. Борется с черными точками и тусклостью."
  },
  {
    icon: "Leaf",
    title: "Успокаивающий дуэт",
    description: "Аллантоин + экстракт гамамелиса снимают покраснения и раздражение."
  },
  {
    icon: "Sun",
    title: "Эффект сияния",
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-6 mb-12">
          <div className="flex-shrink-0">
            <div className="inline-block relative">
              <img 
                src="https://images.unsplash.com/photo-1620916566398-39f1143ab7be?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8c2tpbmNhcmUlMjB0b25lcnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60" 
                ...
                <div className="flex flex-col h-full">
                  <div className="mb-4">
                    <div className="inline-flex items-center justify-center rounded-lg bg-dbyou-lavender/60 p-2">
                      <Icon name={feature.icon} className="h-6 w-6 text-dbyou-purple" />
                    </div>
                  </div>
                  <h3 className="font-medium text-lg mb-2">{feature.title}</h3>
                  <p className="text-dbyou-purple/80 flex-grow">{feature.description}</p>
                </div>
              </CardContent>
            </Card>
          ))}
