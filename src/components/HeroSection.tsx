...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        <div className="animate-logo-appear mb-10 relative">
          <div className="absolute -right-16 top-1/2 transform -translate-y-1/2 hidden md:block">
            <img
              ...
              className="h-32 object-contain transform rotate-12 shadow-lg rounded-lg bg-gradient-to-br from-white to-dbyou-lavender/30 p-2"
            />
          </div>
          <img
        ...
        <p className="text-dbyou-purple/80 text-lg md:text-xl max-w-2xl leading-relaxed mb-8">
          Полное руководство по использованию бренда D'BYOU — инновационные
          продукты для красоты и ухода.
        </p>
